...
function do_list($unit_id ="") {
	global $row_fac, $dispatches, $from_top, $from_left, $eol, $conversion;	//	2/4/11
...
?>
		...
		side_bar_html += "<TR class='even'>	<TD  COLSPAN=99 ALIGN='center'><B><?print gettext('Routes to Facility');?>: <I><?php print shorten($row_fac['fac_name'], 20); ?></I></B></TD></TR>\n";
		side_bar_html += "<TR class='odd'>	<TD COLSPAN=99 ALIGN='center'><?print gettext('Click line, icon or map for route');?></TD></TR>\n";
		side_bar_html += "<TR class='even'>	<TD COLSPAN=3></TD><TD ALIGN='center'><?print gettext('Unit');?></TD><TD ALIGN='center'>SLD</TD><TD ALIGN='center'><?print gettext('Facility');?></TD><TD ALIGN='center'><?print gettext('Status');?></TD><TD ALIGN='center'><?print gettext('As of');?></TD></TR>\n";
