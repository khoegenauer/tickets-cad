...
(function (m, b) {
    ...
    d.merge = function (a, f, j, k) {
        ...
        var o;
        for (o in f)
            if (f.hasOwnProperty(o) && d.indexOf(k, o) < 0)
                if (typeof a[o] !== "object" || !j) {
                    a[o] = f[o];
                    k.push(f[o])
...
(function (m, b) {
    ...
    d.prototype.on = function (c, h) {
        ...
        if (this.$events[c])
            if (b.util.isArray(this.$events[c])) this.$events[c].push(h);
    ...
    d.prototype.removeListener = function (c, h) {
        if (this.$events && this.$events[c]) {
            var e =
                this.$events[c];
            if (b.util.isArray(e)) {
                for (var a = -1, f = 0, j = e.length; f < j; f++)
                    if (e[f] === h || e[f].listener && e[f].listener === h) {
                        a = f;
                        break
                    }
                if (a < 0) return this;
            ...
            if (p && typeof p === "object") {
                ...
                for (B in y)
                    if (Object.prototype.hasOwnProperty.call(y, B))
                        if (C = h(B, y)) A.push(c(B) + (j ? ": " : ":") + C); C = A.length === 0 ? "{}" : j ? "{\n" + j + A.join(",\n" + j) + "\n" + w + "}" : "{" + A.join(",") + "}";
            j = w;
            return C
        }
    }
...
(function (m, b) {
    ...
    d.prototype.onData = function (c) {
        ...
        if (c !== "")
            if ((c = b.parser.decodePayload(c)) && c.length)
                for (var h = 0, e = c.length; h < e; h++) this.onPacket(c[h]);
        return this
    };
...
(function (m, b, d) {
    ...
    c.prototype.publish = function () {
        this.emit.apply(this,
            arguments);
        var e;
        for (var a in this.namespaces)
            if (this.namespaces.hasOwnProperty(a)) {
                e = this.of(a);
    ...
    c.prototype.getTransport = function (e) {
        e = e || this.transports;
        for (var a = 0, f; f = e[a]; a++)
            if (b.Transport[f] && b.Transport[f].check(this) && (!this.isXDomain() || b.Transport[f].xdomainCheck())) return new b.Transport[f](this,
                this.sessionid);
        return null
    };
    ...
    c.prototype.packet = function (e) {
        this.connected && !this.doBuffer ? this.transport.packet(e) :
            this.buffer.push(e);
        return this
    };
    ...
    c.prototype.isXDomain = function () {
        var e =
            window.location.port || ("https:" == window.location.protocol ? 443 : 80);
    ...
    c.prototype.reconnect = function () {
        function e() {
            if (f.connected) {
                for (var p in f.namespaces) f.namespaces.hasOwnProperty(p) && "" !==
                    p && f.namespaces[p].packet({
                        type: "connect"
                    });
...
(function (m, b) {
    ...
    d.check = function () {
        return "WebSocket" in window && !("__addTask" in WebSocket) || "MozWebSocket" in
            window
    };
...
var swfobject = function () {
        ...
        if (g > 0)
            for (var i =
                ...
                if (s.pv[0] > 0) {
                    var x = n(l);
                    if (x)
                        if (t(J[i].swfVersion) && !(s.wk && s.wk < 312)) {
                            C(l, true);
                            if (q) {
                                r.success = true;
                                r.ref = e(l);
                        ...
                        for (var D =
                            x.length, E = 0; E < D; E++)
                            if (x[E].getAttribute("name").toLowerCase() != "movie") v[x[E].getAttribute("name")] = x[E].getAttribute("value");
                        f(r, v, l, q)
                    } else {
                        j(x);
                        q && q(r)
    ...
    function e(g) {
        var i = null;
        if ((g = n(g)) && g.nodeName == "OBJECT")
            if (typeof g.SetVariable != w) i = g;
    ...
    function f(g, i, l, q) {
        ...
        if (r) {
            ...
            if (typeof i.flashvars != w) i.flashvars += "&" + q;
                ...
                q; if (s.ie && s.win && r.readyState != 4) {
    ...
    function k(g) {
        ...
        else if (g = g.getElementsByTagName(A)[0])
            if (g = g.childNodes)
                for (var l = g.length, q = 0; q < l; q++)!(g[q].nodeType == 1 && g[q].nodeName == "PARAM") && g[q].nodeType != 8 && i.appendChild(g[q].cloneNode(true));
        return i
    }
    ...
    function o(g, i, l) {
        ...
        if (r) {
            ...
            if (s.ie && s.win) {
                ...
                v = "";
                for (var D in i)
                    if (i[D] != Object.prototype[D]) v += '<param name="' + D + '" value="' + i[D] + '" />';
                ...
                for (var E in g)
                    if (g[E] != Object.prototype[E])
                        if (E.toLowerCase() == "styleclass") D.setAttribute("class",
                            g[E]);
                        else E.toLowerCase() != "classid" && D.setAttribute(E, g[E]);
                for (x in i)
                    if (i[x] != Object.prototype[x] && x.toLowerCase() != "movie") {
                        g = D;
                        v = x;
                        E = i[x];
            ...
            if (s.ie && s.win) {
                ...
                (function () {
                    if (i.readyState == 4) {
                        ...
                        if (l) {
                            for (var q in l)
                                if (typeof l[q] == "function") l[q] = null;
    ...
    function G(g) {
        return /[\\\"<>\.;]/.exec(g) !=
            null && typeof encodeURIComponent != w ? encodeURIComponent(g) : g
    }
    var w = "undefined",
        A = "object",
        ...
        s = function () {
            ...
            i = /webkit/.test(i) ?
                parseFloat(i.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : false;
            var r = !+"\u000b1",
                x = [0, 0, 0],
                v = null;
        ...
        embedSWF: function (g, i, l, q, r, x, v, D, E, P) {
            ...
            if (s.w3 && !(s.wk && s.wk < 312) && g && i && l && q && r) {
                ...
                b(function () {
                    ...
                    I = {};
                    if (D && typeof D === A)
                        for (var V in D) I[V] = D[V];
                    if (v && typeof v === A)
                        for (var W in v)
                            if (typeof I.flashvars != w) I.flashvars += "&" + W + "=" + v[W];
        ...
        getQueryParamValue: function (g) {
            ...
            if (i) {
                ...
                for (var l = 0; l < i.length; l++)
                    if (i[l].substring(0, i[l].indexOf("=")) == g) return G(i[l].substring(i[l].indexOf("=") +
                            1))
            }
            return ""
        },
    ...
    if (!window.WebSocket) {
        ...
        if (swfobject.hasFlashPlayerVersion("10.0.0")) {
            ...
            WebSocket.prototype.close = function () {
                if (!(this.readyState ==
                        WebSocket.CLOSED || this.readyState == WebSocket.CLOSING)) {
            ...
            WebSocket.prototype.removeEventListener = function (b, d) {
                if (b in this.__events)
                    for (var c = this.__events[b], h = c.length - 1; h >= 0; --h)
                        if (c[h] === d) {
                            c.splice(h, 1);
                            break
                        }
