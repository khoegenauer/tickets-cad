...
?>
            ...
            var dummymarker = createdummyUnitMarker(point, myinfoTabs, <?php print $row['unit_id']; ?>);	// 859  - 7/28/10. Plots dummy icon in default position for units added in no maps operation
            dummymarker.setMap(map);
<?php
        } else {
?>
