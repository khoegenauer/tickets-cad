...
(function() {
  ...
  Layer = L.Class.extend({
    ...
    buildMarker: function(st, ll) {
      ...
      popupContent += "<p>";
      popupContent += "" + this.i18n.currentTemperature + ":&nbsp;" + (this.toCelc(st.temp)) + "&nbsp;°F<br />";
      if (st.temp_max) {
        popupContent += "" + this.i18n.maximumTemperature + ":&nbsp;" + (this.toCelc(st.temp_max)) + "&nbsp;°F<br />";
      }
      if (st.temp_min) {
        popupContent += "" + this.i18n.minimumTemperature + ":&nbsp;" + (this.toCelc(st.temp_min)) + "&nbsp;°F<br />";
      }
      popupContent += "" + this.i18n.humidity + ":&nbsp;" + st.humidity + "%<br />";
//    popupContent += "" + this.i18n.wind + ":&nbsp;" + st.wind_ms + "&nbsp;m/s<br />";
      popupContent += "" + this.i18n.wind + ":&nbsp;" + (st.wind_ms * 2.23).toFixed(0) + "&nbsp;mph<br />";
      popupContent += "</p>";
      popupContent += "</div>";
      typeIcon = this.typeIcon(st);
      markerIcon = typeIcon ? new Icon({
        image: typeIcon,
        text: "" + (this.toCelc(st.temp)) + "&nbsp;°F",
        textOffset: 30
      }) : new Icon({
        image: weatherIcon,
        text: "" + (this.toCelc(st.temp)) + "&nbsp;°F",
...
//      return Math.round((t - 273.15) * p) / p;
      c = Math.round((t - 273.15) * p) / p;	// F = °F × 1.8 + 32
