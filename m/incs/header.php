...
/*
7/20/2013 - HAS  functions included
*/
...
//		alert ("the_size " + the_size);
    ...
    function SF_callback(req) {						// pro-forma
//		alert("SF_callback");
