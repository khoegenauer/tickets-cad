...
echo "<div class = 'even' id='header' style = 'position:fixed; top:0; width:100%; background-color:{$_SESSION['css']['page_background']};  margin-top:0px; height:auto; text-align:center; vertical-align: middle;'>
	<span id = 'ht' class='head_butt' onClick = 'document/toTickets.submit();'><img src='images/t.png' BORDER=0 style = 'margin-top:4px;'/> </span>	<span class = 'butt-sep'>|</span>
	...
	<div id = 'container' style = 'width: 100%;  overflow:scroll; margin-top:60px;'>
	\n";
?>
