...
-->
	<div id="map" style="width: <?php echo ($_SESSION['scr_width']-20);?>px; height: <?php echo ($_SESSION['scr_height'] - 260);?>px; "></div>	<!-- % fails here -->
...
/*
			$query = "SELECT * FROM `$GLOBALS[mysql_prefix]roadinfo`  LIMIT 0";
...
<script>
function getLocation(<?php echo $_SESSION['user_unit_id'];?>) {
