...
12/13/2013 include recent closed tickets
12/15/2013 included 'address_about'
*/
...
<?php	
		...
		echo "\n<br/><br/><center><h2>Selected " . get_text("Incident") . " (# {$the_nth} of {$the_count} )</h2>\n";
		...
		echo "<table class = 'single' id = 'inner' border=1>\n";
/*
...
*/
		...
		if ($_SESSION['SP']['do_map'] == 1 ) {	
			echo "<input type = 'button' value = 'to Map' onclick = 'call_map();' />";
			}		// end do_map
		if ( ! ( ( sp_is_guest() ) || ( sp_is_member() ) )  ) {						// disallow
			echo "<input type = 'button' value = 'Close " . get_text("Incident") . "' onclick = 'call_close();' style = 'margin-left:40px;' />";
			}
		echo "</td></tr>\n";
		echo "</table></div>\n";
