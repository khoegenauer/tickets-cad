<?php
/**
 * @package message_detail2.php
 * @author John Doe <john.doe@example.com>
 * @since
 * @version
 */
/*
9/10/13 - new file - gets message detail for mobile screen (for messages associated with a particular Ticket
*/
@session_start();
...
$print .= "<SPAN id='close_message_detail' class='plain' style='float: right; z-index: 999999; text-align: center; width: 40px;' onMouseOver='do_hover(this.id);' onMouseOut='do_plain(this.id);' onClick='close_tkt_message_detail();'><IMG SRC = './images/close.png' BORDER=0 STYLE = 'vertical-align: middle'/></span>";
