...
if (mysql_num_rows($result) == 0) {
    $print = "<TABLE style='width: 100%;'><TR style='width: 100%;'><TD style='width: 100%;'>" . gettext('No Assignments Currently') . "</TD></TR></TABLE>";
    } else {
    $print = "<TABLE style='width: 100%;'>";
    $print .= "<TR class='heading' style='width: 100%; font-weight: bold; color: #FFFFFF; background-color: #707070;'><TD style='width: 30%;'>" . gettext('TICKET NAME') . "</TD><TD style='width: 50%;'>" . gettext('DESCRIPTION') . "</TD><TD style='width: 20%;'>" . gettext('PROBLEMSTART') . "</TD></TR>";
