...
<BODY>
    <DIV>
    <FONT CLASS="header"><?php print gettext('Chat');?></FONT> <I>(<?php print gettext('logged-in');?>: <span id='whos_chatting'></span>)</I><BR /><BR />
    </DIV>
    ...
    <DIV STYLE = 'background-color: #707070; text-align: left; position: relative; bottom: 0px; margin: 5px; padding: 5px; color: #FFFFFF; border: 2px outset #DEDEDE; vertical-align: top;'>
        ...
        <INPUT TYPE="button" VALUE = "<?php print gettext('Send');?>" onClick="wr_chat_msg(document.forms['chat_form']);set_to();"  style='margin-left:20px;' >
