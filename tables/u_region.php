...
?>
    ...
    <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right"><?php print gettext('Def Area Code');?>:</TD>
        <TD><INPUT ID="ID3" CLASS="dirty" MAXLENGTH="4" SIZE="4" type="text" NAME="frm_def_area_code" VALUE="<?php print $row['def_area_code'];?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value);" /> <SPAN class='warn' ><?php print gettext('Integer');?></SPAN></TD></TR>
    <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right"><?php print gettext('Def City');?>:</TD>
        <TD><INPUT ID="ID4" CLASS="dirty" MAXLENGTH="20" SIZE="20" type="text" NAME="frm_def_city" VALUE="<?php print $row['def_city'];?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value);" /> <SPAN class='warn' ><?php print gettext('text');?></SPAN></TD></TR>
    <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right"><?php print gettext('Def Latitude');?>:</TD>
        <TD><INPUT ID="ID5" CLASS="dirty" MAXLENGTH="10" SIZE="10" type="text" NAME="frm_def_lat" VALUE="<?php print $row['def_lat'];?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value);" /> <SPAN class='warn' ><?php print gettext('Double');?></SPAN></TD></TR>
    <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right"><?php print gettext('Def Longitude');?>:</TD>
        <TD><INPUT ID="ID6" CLASS="dirty" MAXLENGTH="10" SIZE="10" type="text" NAME="frm_def_lng" VALUE="<?php print $row['def_lng'];?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value);" /> <SPAN class='warn' ><?php print gettext('Double');?></SPAN></TD></TR>
    <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right"><?php print gettext('Def State');?>:</TD>
        <TD><INPUT ID="ID7" CLASS="dirty" MAXLENGTH="20" SIZE="20" type="text" NAME="frm_def_st" VALUE="<?php print $row['def_st'];?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value);" /> <SPAN class='warn' ><?php print gettext('text');?></SPAN></TD></TR>
    <TR VALIGN="baseline" CLASS="even"><TD CLASS="td_label" ALIGN="right"><?php print gettext('Def Zoom');?>:</TD>
        <TD><INPUT ID="ID8" CLASS="dirty" MAXLENGTH="2" SIZE="2" type="text" NAME="frm_def_zoom" VALUE="<?php print $row['def_zoom'];?>" onFocus="JSfnChangeClass(this.id, 'dirty');" onChange = "this.value=JSfnTrim(this.value);" /> <SPAN class='warn' ><?php print gettext('Integer');?></SPAN></TD></TR>
    <TR VALIGN="baseline" CLASS="odd"><TD CLASS="td_label" ALIGN="right"><?php print gettext('Boundary');?>:</TD>
