...
?>
	...
	side_bar_html += "<TR class='even'><TD ALIGN='left'><B>ID</B></TD><TD ALIGN='left'><B>Unit</B></TD><TD ALIGN='left'><B>Dispatch</B></TD><TD ALIGN='left'><B>Status</B></TD><TD ALIGN='left'><B>As of</B></TD></TR>";
	var which;
...
//		$sidebar_line = "<TD onClick = '{$on_click}'><SPAN STYLE='background-color:{$the_bg_color};  opacity: .7; color:{$the_text_color};'>  " . shorten($display_name, 16) . "</B></U></SPAN></TD>";
...
// assignments 3/16/09, 3/15/10
		...
		$query = "SELECT * FROM `$GLOBALS[mysql_prefix]assigns` 
			...
			WHERE `responder_id` = '{$row['unit_id']}' AND `clear` IS NULL ";
...
?>
			...
			<FORM NAME='can_Form' METHOD="post" ACTION = "<?php print basename( __FILE__);?>"></FORM>
			<FORM NAME="to_edit_Form" METHOD="post" ACTION = "units_nm.php?func=responder&edit=true&id=<?php print $id; ?>"></FORM>
...
?>
			...
			<FORM NAME='can_Form' METHOD="post" ACTION = "units_nm.php?func=responder"></FORM>
			<!-- 1452 -->
